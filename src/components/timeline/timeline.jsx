...
const Timeline = () => {
    const [activeDay, setActiveDay] = useState("Event Day");
                    ...
                    <div className="rounded-[6rem] border border-black bg-[#FAF5FF] w-full pt-8 px-6 pb-6 relative overflow-hidden">
                        ...
                        <div className="flex justify-center mb-5 md:mb-10 lg:mb-20">
                            <div className="flex bg-[#FFD32B] p-2.5 rounded-3xl border border-black">
                                <div className="px-2 md:px-12 py-2 rounded-2xl font-archivo font-bold text-lg sm:text-2xl md:text-3xl lg:text-4xl text-black bg-white border border-black shadow-[inset_2px_2px_4px_rgba(0,0,0,0.25)]">
                                    Event Day
                                </div>
                            </div>
                        </div>
