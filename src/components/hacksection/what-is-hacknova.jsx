                ...
                <div className="flex flex-col items-center justify-center gap-8 md:gap-16 max-w-7xl px-8">
                    ...
                    <div className="leading-[1.2rem] sm:leading-normal">
                        <div className="text-black text-center text-[0.8rem] sm:text-base md:text-xl  xl:text-[1.75rem] pt-2 font-semibold font-archivo leading-relaxed sm:leading-relaxed lg:leading-[55px]">
                            ...
                            {" "}is a dynamic hackathon that challenges participants to code, create, and conquer real-world problems through innovative solutions. More than just a coding competition, it's a transformative experience where imagination meets reality, bringing together passionate innovators to tackle meaningful challenges and push technological boundaries.
                        </div>
                        ...
                        <div className="text-black text-center text-[0.8rem] sm:text-base md:text-xl   xl:text-[1.75rem] font-archivo  leading-normal lg:pt-8 font-semibold sm:leading-relaxed lg:leading-[55px]">
                            Whether you're a coding novice or seasoned developer, HACKNOVA offers the perfect platform to experiment, collaborate, and showcase your talent. This is your opportunity to think differently, embrace innovation, and be part of building the future. Are you ready to{" "}
                            <span className="text-[#7920D0]">
                                code, create, and conquer?
                            </span>{" "}
                            Join HACKNOVA 2025 and be part of something extraordinary!
                        </div>
                    </div>
                </div>
            </div>
